...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleDataIntegrity(
    ...
    String message =
        "Error de integridad de datos. Verifica que todos los campos requeridos estén presentes.";
  ...
  public ResponseEntity<ErrorResponse> handleInventoryExists(
          InventoryAlreadyExistsException ex, HttpServletRequest request) {
